...
const AddBookAuthor = ({ authUser, token}) => {
  ...
  const addBook = () => {
    axios.post("http://localhost:8083/books/createBook",
                { uid: authUser.uid, title: title, description:bookDescription, pages:234, category1_id:category1, category2_id:category2, category3_id:category3, cover_link:photoUrl},
                config)
                .then((result) => {
                    console.log(result);
